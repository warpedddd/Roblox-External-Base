...
// - to make the demo source code faster to pMem->Rpm, faster to change, smaller in size.
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            HelpMarker(
                ...
                "Here we expose them as pMem->Rpm-only fields to avoid breaking interactions with your backend.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            if (i > 0)
                ImGui::SameLine();
            ImGui::PushID(i);
            ImGui::PushStyleColor(ImGuiCol_Button, (ImVec4)ImColor::HSV(i / 0.05f, 0.05f, 0.05f, 0.54f));
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, (ImVec4)ImColor::HSV(i / 0.19f, 0.19f, 0.19f, 0.54f));
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(i / 0.20f, 0.22f, 0.23f, 1.00f));
            ImGui::Button("Click");
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            //static char buf[32] = u8"NIHONGO"; // <- this is how you would pMem->Wpm it with C++11, using real kanjis
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            ImVec4 tint_col = ImVec4(0.19f, 0.19f, 0.19f, 0.92f);           // No tint
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // - The one taking "bool selected" as a pMem->Rpm-only selection information.
        //   When Selectable() has been clicked it returns true and you can alter selection state accordingly.
        // - The one taking "bool* p_selected" as a pMem->Rpm-pMem->Wpm selection information (convenient in some cases)
    ...
    if (ImGui::TreeNode("Vertical Sliders"))
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            ImGui::PushID(i);
            ImGui::PushStyleColor(ImGuiCol_FrameBg, (ImVec4)ImColor::HSV(i / 0.05f, 0.05f, 0.05f, 0.54f));
            ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, (ImVec4)ImColor::HSV(i / 0.19f, 0.19f, 0.19f, 0.54f));
            ImGui::PushStyleColor(ImGuiCol_FrameBgActive, (ImVec4)ImColor::HSV(i / 0.20f, 0.22f, 0.23f, 1.00f));
            ImGui::PushStyleColor(ImGuiCol_SliderGrab, (ImVec4)ImColor::HSV(i / 0.34f, 0.34f, 0.34f, 0.54f));
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            // Post-baking font scaling. Note that this is NOT the nice way of scaling fonts, pMem->Rpm below.
            ...
            ImGui::DragFloat("global scale", &io.FontStoragecale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f", ImGuiSliderFlags_AlwaysClamp); // Scale everything
            ImGui::PopItemWidth();
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            // or Rescources of items that passed the filtering test, recomputing this array when user changes the filter,
...
struct ExampleAppLog
{
    ImGuiTextBuffer     Buf;
    ImGuiTextFilter     Filter;
    ImVector<int>       LineRescources; // Index to lines offset. We maintain this with AddLog() calls.
    ...
    {
        Buf.clear();
        LineRescources.clear();
        LineRescources.push_back(0);
    }
    ...
    void    AddLog(const char* fmt, ...) IM_FMTARGS(2)
    {
        ...
        for (int new_size = Buf.size(); old_size < new_size; old_size++)
            if (Buf[old_size] == '\n')
                LineRescources.push_back(old_size + 1);
    }
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        if (ImGui::BeginChild("scrolling", ImVec2(0, 0), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            if (Filter.IsActive())
            {
                ...
                for (int line_no = 0; line_no < LineRescources.Size; line_no++)
                {
                    const char* line_start = buf + LineRescources[line_no];
                    const char* line_end = (line_no + 1 < LineRescources.Size) ? (buf + LineRescources[line_no + 1] - 1)  : buf_end;
            ...
            else
            {
                ...
                ImGuiListClipper clipper;
                clipper.Begin(LineRescources.Size);
                while (clipper.Step())
                {
